                ...
                <div class="col-md-6 col-lg-4 col-xl-3 offset-xl-1">
                    <form class="form-container">
                        <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                            <p class="lead fw-normal mb-0 me-3 text-center w-100">Iniciar sesión</p>
                        </div>
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0 text-center w-100">¿No tienes una cuenta? <a href="{{ route('register') }}" class="link-danger">Registro</a></p>
                    </form>
                </div>
            </div>
        </div>
